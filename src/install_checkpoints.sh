...
# # dark sushi
# wget https://civitai.com/api/download/models/24779 --content-disposition -P ./models/checkpoints/

# # anylora
# wget https://civitai.com/api/download/models/23900 --content-disposition -P ./models/checkpoints/
